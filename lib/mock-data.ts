...
//
// Sort order groups by class (covered first because it's typically
// the premium tier operators want to look at first) then by size.

const BASE_SLIP_TYPES: SlipType[] = [
  // ── Covered (premium) ──
  {
    id: "st_covered_up_to_30",
    tenant_id: SEED_TENANT_ID,
    class: "covered",
    max_loa_inches: 30 * 12,
    display_label: "Covered up to 30 ft",
    short_label: "C ≤30",
    description: "Covered slip, smaller boats. Roof, top-tier protection.",
    default_annual_rate: 5400,
    default_monthly_rate: 540,
    default_seasonal_rate: 3000,
    default_transient_rate_per_night: 55,
    included_amenities: { power: true, water: true },
    included_fee_ids: [],
    sort_order: 10,
    active: true,
  },
  {
    ...
    tenant_id: SEED_TENANT_ID,
    class: "covered",
    min_loa_inches: 30 * 12 + 1,
    max_loa_inches: 40 * 12,
    display_label: "Covered 30–40 ft",
    short_label: "C30–40",
    default_annual_rate: 7500,
    default_monthly_rate: 700,
    default_seasonal_rate: 4200,
    default_transient_rate_per_night: 75,
    included_amenities: { power: true, water: true },
    included_fee_ids: [],
    sort_order: 11,
    active: true,
  },
  {
    ...
    tenant_id: SEED_TENANT_ID,
    class: "covered",
    min_loa_inches: 40 * 12 + 1,
    max_loa_inches: 50 * 12,
    display_label: "Covered 40–50 ft",
    short_label: "C40–50",
    default_annual_rate: 9800,
    default_monthly_rate: 900,
    default_seasonal_rate: 5500,
    default_transient_rate_per_night: 95,
    included_amenities: { power: true, water: true },
    included_fee_ids: [],
    sort_order: 12,
    active: true,
  ...
  {
    id: "st_covered_50_plus",
    tenant_id: SEED_TENANT_ID,
    class: "covered",
    min_loa_inches: 50 * 12 + 1,
    max_loa_inches: 999 * 12,
    display_label: "Covered 50+ ft",
    short_label: "C50+",
    default_annual_rate: 12600,
    default_monthly_rate: 1150,
    default_seasonal_rate: 7000,
    default_transient_rate_per_night: 120,
    included_amenities: { power: true, water: true },
    included_fee_ids: [],
    sort_order: 13,
    active: true,
  ...
  // ── Uncovered (standard) ──
  {
    id: "st_uncovered_up_to_30",
    tenant_id: SEED_TENANT_ID,
    class: "uncovered",
    max_loa_inches: 30 * 12,
    display_label: "Uncovered up to 30 ft",
    short_label: "U ≤30",
    default_annual_rate: 3200,
    default_monthly_rate: 320,
    default_seasonal_rate: 1800,
    default_transient_rate_per_night: 35,
    included_amenities: { power: true, water: true },
    included_fee_ids: [],
    sort_order: 20,
    active: true,
  ...
  {
    id: "st_uncovered_30_40",
    tenant_id: SEED_TENANT_ID,
    class: "uncovered",
    min_loa_inches: 30 * 12 + 1,
    max_loa_inches: 40 * 12,
    display_label: "Uncovered 30–40 ft",
    short_label: "U30–40",
    default_annual_rate: 4800,
    default_monthly_rate: 460,
    default_seasonal_rate: 2700,
    default_transient_rate_per_night: 50,
    included_amenities: { power: true, water: true },
    included_fee_ids: [],
    sort_order: 21,
    active: true,
  ...
  {
    id: "st_uncovered_40_plus",
    tenant_id: SEED_TENANT_ID,
    class: "uncovered",
    min_loa_inches: 40 * 12 + 1,
    max_loa_inches: 999 * 12,
    display_label: "Uncovered 40+ ft",
    short_label: "U40+",
    default_annual_rate: 6500,
    default_monthly_rate: 600,
    default_seasonal_rate: 3700,
    default_transient_rate_per_night: 70,
    included_amenities: { power: true, water: true },
    included_fee_ids: [],
    sort_order: 22,
    active: true,
  ...
  // ── T-head (premium end-of-dock) ──
  {
    id: "st_t_head_40_50",
    tenant_id: SEED_TENANT_ID,
    class: "t_head",
    max_loa_inches: 50 * 12,
    display_label: "T-head up to 50 ft",
    short_label: "T ≤50",
    description: "End-of-dock with extra clearance. Premium pricing.",
    default_annual_rate: 11500,
    default_monthly_rate: 1050,
    default_seasonal_rate: 6400,
    default_transient_rate_per_night: 110,
    included_amenities: { power: true, water: true },
    included_fee_ids: [],
    sort_order: 30,
    active: true,
  ...
  {
    id: "st_t_head_50_plus",
    tenant_id: SEED_TENANT_ID,
    class: "t_head",
    min_loa_inches: 50 * 12 + 1,
    max_loa_inches: 999 * 12,
    display_label: "T-head 50+ ft",
    short_label: "T50+",
    default_annual_rate: 14800,
    default_monthly_rate: 1300,
    default_seasonal_rate: 8200,
    default_transient_rate_per_night: 145,
    included_amenities: { power: true, water: true },
    included_fee_ids: [],
    sort_order: 31,
    active: true,
  ...
  // ── Buoy (mooring) ──
  {
    ...
    class: "buoy",
    max_loa_inches: 999 * 12,
    display_label: "Mooring buoy",
    short_label: "Buoy",
    description: "Mooring ball — no shore power or water.",
    default_annual_rate: 1800,
    default_monthly_rate: 200,
    default_seasonal_rate: 1100,
    default_transient_rate_per_night: 25,
    included_amenities: { power: false, water: false },
    included_fee_ids: [],
    sort_order: 40,
    active: true,
  },
  ...
  // ── Dry storage ──
  {
    ...
    class: "dry_storage",
    max_loa_inches: 30 * 12,
    display_label: "Dry storage up to 30 ft",
    short_label: "D ≤30",
    description: "Out of water — indoor or yard.",
    default_annual_rate: 2400,
    default_monthly_rate: 260,
    default_seasonal_rate: 1400,
    included_amenities: { power: false, water: false },
    included_fee_ids: [],
    sort_order: 50,
    active: true,
  },
  {
    ...
    min_loa_inches: 30 * 12 + 1,
    max_loa_inches: 999 * 12,
    display_label: "Dry storage 30+ ft",
    short_label: "D30+",
    default_annual_rate: 3600,
    default_monthly_rate: 380,
    default_seasonal_rate: 2100,
    included_amenities: { power: false, water: false },
    included_fee_ids: [],
    sort_order: 51,
    active: true,
...
export const SLIP_TYPES: SlipType[] = withTenantId(BASE_SLIP_TYPES);
...
const BASE_WAITLIST: WaitlistEntry[] = [
  ...
  },
  {
    ...
    preferred_classes: ["covered", "t_head"],
